...
import {
  ...
  lineAmount,
  sumLineAmounts,
} from "@/features/invoices/templates/invoice_fluvo_1/invoice-fluvo-1-calculations";
...
export function InvoiceFluvo1Template() {
  ...
  const [fromAddress, setFromAddress] = useState("12857 W Main St, Glendale, AZ");
  ...
  const [billAddress, setBillAddress] = useState("742 Evergreen Industrial Rd.");
