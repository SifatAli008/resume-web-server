...
const FIELD_RIGHT =
  "w-full min-w-0 border-0 border-b border-transparent bg-transparent py-0.5 text-sm text-zinc-800 focus:border-[#E8502D] focus:outline-none text-right tabular-nums";

export type InvoiceFluvo10SubtotalsProps = {
  subtotal: number;
  discount: string;
...
export function InvoiceFluvo10Subtotals({
  subtotal,
  discount,
  invoiceTaxPercent,
  taxAmount,
      ...
      <div className="w-full max-w-sm space-y-0 text-sm">
        ...
        <div className="flex items-center justify-between gap-6 py-2.5">
          <span className="font-bold text-zinc-900">
            Tax(
            <input
              className="inline-block w-9 border-0 border-b border-transparent bg-transparent text-right font-bold focus:border-[#E8502D] focus:outline-none"
