...
export type InvoiceFluvo8BillingInfoProps = {
  fromName: string;
  fromAddress: string;
  fromPhone: string;
  fromEmail: string;
...
export function InvoiceFluvo8BillingInfo({
  fromName,
  fromAddress,
  fromPhone,
  fromEmail,
  ...
  return (
    <section className="grid gap-10 sm:grid-cols-2">
      ...
      <div className="space-y-1.5 text-sm">
        <p className="text-xs font-bold" style={{ color: "#6b6ba3" }}>
          Bill To
        </p>
        <input
          className={cn(FIELD, "font-bold")}
