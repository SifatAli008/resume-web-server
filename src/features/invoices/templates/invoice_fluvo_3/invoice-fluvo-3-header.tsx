...
export type InvoiceFluvo3HeaderProps = {
...
export function InvoiceFluvo3Header({
  invoiceNumber,
  invoiceDate,
  dueDate,
  poNumber,
  ...
  onDueDateChange,
  onPoNumberChange,
}: InvoiceFluvo3HeaderProps) {
  return (
    <header className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
      <h1 className="text-4xl font-bold uppercase tracking-tight text-red-700 sm:text-5xl">
        INVOICE
      </h1>
