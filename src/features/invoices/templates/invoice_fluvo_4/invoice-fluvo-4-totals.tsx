...
export type InvoiceFluvo4TotalsProps = {
  subtotal: number;
  discount: string;
...
export function InvoiceFluvo4Totals({
  subtotal,
  discount,
  invoiceTaxPercent,
  taxAmount,
      ...
      <div className="w-full max-w-sm space-y-0 text-sm">
        ...
        <div className="flex items-center justify-between gap-6 border-b border-zinc-200 py-2.5">
          <span className="font-bold text-zinc-900">
            Tax (
            <input
              className="inline-block w-9 border-0 border-b border-transparent bg-transparent text-right font-bold focus:border-green-600 focus:outline-none"
        ...
        <div className="mt-2 flex justify-between gap-6 bg-green-600 px-4 py-4 text-lg font-bold text-white">
          <span>TOTAL</span>
