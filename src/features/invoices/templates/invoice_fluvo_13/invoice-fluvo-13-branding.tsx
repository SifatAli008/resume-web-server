...
type InvoiceFluvo13BrandingProps = {
  logoUrl: string | null;
...
export function InvoiceFluvo13Branding({
  logoUrl,
  onLogoUrlChange,
  headerBgUrl,
  onHeaderBgUrlChange,
  className,
}: InvoiceFluvo13BrandingProps) {
  ...
  return (
    ...
    >
      ...
      <span className="mx-1 hidden h-5 w-px self-center bg-blue-200 sm:inline" />
